...
<div class="tab-content" id="myTabContent">
	...
	<form class="form-signin text-center">
		...
		<input type="text" id="up-name" class="form-control" placeholder="Nome Completo" required autofocus>
		<label for="up-email" class="sr-only">E-mail</label>
		<input type="email" id="up-email" class="form-control" placeholder="E-mail" required>
		<label for="up-password" class="sr-only">Senha</label>
		<input type="password" id="up-password" class="form-control" placeholder="Senha" required>
		<br/>
